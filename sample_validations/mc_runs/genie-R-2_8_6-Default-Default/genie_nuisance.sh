...
source $outdir/../genie-R-2_8_6-build-2017-07-10/genie_setup.sh
source $outdir/../nuisance-master-genie-R-2_8_6-build-2017-07-10/build/Linux/setup.sh

# Define the model to use
export GXMLPATH=$outdir/../official_configs/Default/
export GMODEL="--cross-sections $GXMLPATH/gxspl-NuMIsmall.xml --event-generator-list Default"
...
#PrepareGENIE -i gntp.R-2_8_6.OfficialDefault.Default.${fluxid}.${targetid}.${nevents}.${run}.prepared.root -f $flux -t $nuisancetarget

# Move to properly named file
mv genie-mcjob-${run}.status gntp.R-2_8_6.OfficialDefault.Default.${fluxid}.${targetid}.${nevents}.${run}.ghep.genie-mcjob-${run}.status
mv gntp.${run}.prepared.root gntp.R-2_8_6.OfficialDefault.Default.${fluxid}.${targetid}.${nevents}.${run}.prepared.root
