...
# Copy Flux Folder
mkdir flux
cp ../nuisance-master-genie-R-2_8_6-build-2017-07-10/data/flux/*.root ./flux/
...
#$command genie_nuisance.sh 2 $nevents MINERvA_rhc_numubar '\-14' $PWD/flux/minerva_flux.root,numubar_rhc CH 1000060120[0.9231],1000010010[0.0769] 1000060120,1000010010  $extracommands
#$command genie_nuisance.sh 3 $nevents_nue MINERvA_fhc_nue     12 $PWD/flux/minerva_flux.root,nue_fhc     CH 1000060120[0.9231],1000010010[0.0769] 1000060120,1000010010  $extracommands
$command genie_nuisance.sh 4 $nevents_nuebar MINERvA_fhc_nuebar m12 $PWD/flux/minerva_flux.root,nuebar_fhc  CH 1000060120[0.9231],1000010010[0.0769] 1000060120,1000010010  $extracommands
